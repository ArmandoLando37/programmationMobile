...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String CLE_EMAIL2 = "email_memorise2";
    ...
    private void tenterConnexion() {
        ...
        if (connexionReussie) {
            ...
            sauvegarderEmailSiNecessaire(email,motDePasse);
